                  ...
                  <TableCell>
                    <div className="flex items-center gap-1">
                      ...
                      {/* 2. ADJUST PRIORITY (Simple Cycle for now or Dialog) */}
                       ...
                       <Popover>
                        <PopoverTrigger asChild>
                            <Button 
                              ...
                              disabled={report.status === ReportStatus.RESOLVED || report.status === ReportStatus.REJECTED}
                            >
                       ...
                       {/* 3. NOTIFY VOLUNTEERS */}
                       <Button variant="ghost" size="icon" title="Notify Volunteer" onClick={() => toast.success(t("REPORTS.NOTIFICATIONS.SENT_SUCCESS"))}>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span
                    ...
                    >
                      {t(`REPORTS.STATUS.${selectedReport.status.toUpperCase()}`)}
                    </span>
                </div>
                 <div>
